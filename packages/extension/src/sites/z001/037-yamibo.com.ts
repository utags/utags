...
export default (() => {
  const prefix = 'https://bbs.yamibo.com/'
  ...
  // https://bbs.yamibo.com/forum.php?mod=forumdisplay&fid=5&filter=typeid&typeid=4
  // https://bbs.yamibo.com/forum.php?mod=forumdisplay&fid=5&filter=typeid&typeid=4
  function getUserProfileUrl(url: string, exact = false) {
    if (url.startsWith(prefix)) {
      ...
      if (exact) {
        ...
        // https://bbs.yamibo.com/space-uid-1234567.html
        ...
        // https://bbs.yamibo.com/home.php?mod=space&uid=234567
  ...
  function getPostUrl(url: string) {
    if (url.startsWith(prefix)) {
      ...
      // https://bbs.yamibo.com/thread-1234567-1-1.html
      ...
      // https://bbs.yamibo.com/forum.php?mod=redirect&tid=1234567&goto=lastpost#lastpost
      ...
      // https://bbs.yamibo.com/forum.php?mod=viewthread&tid=1234567
