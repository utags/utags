...
4. **扩展图标**：浏览器工具栏中的 UTags 图标，点击可访问设置和其他功能
   ...
   ![添加标签截图](../assets/extension-usage-7.png)
...
5. 是否启用快速添加星标
   ...
   ![添加标签截图](../assets/extension-settings-1.png)
   </BrowserWindow>
...
<!-- 3. 在弹出的输入框中编辑标签 -->
  ...
  <BrowserWindow url="https://www.tiktok.com/">
   ![添加标签截图](../assets/extension-edit-1.png)
  </BrowserWindow>
  <BrowserWindow url="https://www.tiktok.com/">
   ![添加标签截图](../assets/extension-edit-2.png)
  </BrowserWindow>
...
<!-- 4. 如果要删除所有标签，清空输入框 -->
  ...
  <BrowserWindow url="https://www.tiktok.com/">
   ![添加标签截图](../assets/extension-delete-1.png)
  </BrowserWindow>
...
- **`block`** or **`hide`**：屏蔽带有此标签的内容，使其不再显示
...
2. 向开发者[反馈问题](https://github.com/utags/utags/issues)
