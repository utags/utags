...
新的變更日誌將在 [https://github.com/utags/utags/tree/main/docs/release-notes](https://github.com/utags/utags/tree/main/docs/release-notes) 發布，此文件不再更新變更日誌。
...
- 0.21
  ...
  - 新增選單命令：一鍵隱藏/取消隱藏所有標籤，支援動態標題與多語言。
- 0.20
