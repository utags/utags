# UTags - Adicionar tags de usuário a links
...
- 0.23
  - Otimizar a lógica de fallback da API GM.\*.
  - Melhorar a compatibilidade com gerenciadores de scripts como Greasymonkey, quoid-userscripts, Stay, etc.
  - Melhorar a interação do teclado para as teclas Escape e Tab.
  - Corrigir problema no Safari onde fechar o painel de entrada de tags rola a página para o fundo.
- 0.22
...
- 0.19.x
  ...
  - Habilitar estilo de tags na janela de entrada de tags
...
- 0.9.8
  - twitter.com -> x.com
  - Correção de problemas com github.com, threads.net
- 0.9.5
...
- 0.8.9
  - Atualização de estilos e regras de correspondência para bilibili.com, greasyfork.org, youtube.com, douyin.com
- 0.8.8
