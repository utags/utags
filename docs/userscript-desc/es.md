# UTags - Agregar etiquetas de usuario a enlaces
...
- Y muchos más. Haga clic [aquí](https://github.com/utags/utags/issues) para sugerir nuevos sitios.

Si desea usar UTags en otros sitios, simplemente agregue en la configuración del script una regla `user matches` para el sitio objetivo.
...
- 0.23
  ...
  - Mejorar la interacción del teclado para las teclas Escape y Tab.
  - Corregir problema en Safari donde cerrar el panel de entrada de etiquetas desplaza la página hacia abajo.
- 0.22
  - Se eliminó `// @noframes` y se habilitó `all_frames: true` para permitir que UTags se ejecute dentro de iframes, mejorando la compatibilidad con la extensión utags-shortcuts y userscripts.
  - Módulo de configuración actualizado.
- 0.21
  ...
  - Nuevo comando de menú: Ocultar/Mostrar todas las etiquetas con título dinámico y soporte multilingüe.
- 0.20
  ...
  - Agregar nuevas etiquetas especiales que comienzan con signos de exclamación: !, !!, !!!, !important para marcado de prioridad
- 0.19.x
...
- 0.9.8
  - twitter.com -> x.com
  - Corrección de problemas con github.com, threads.net
- 0.9.5
...
- 0.8.9
  - Actualización de estilos y reglas de coincidencia para bilibili.com, greasyfork.org, youtube.com, douyin.com
- 0.8.8
