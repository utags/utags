...
- 0.23
  ...
  - Улучшено взаимодействие с клавиатурой для клавиш Escape и Tab.
  - Исправлена проблема в Safari, когда закрытие панели ввода тегов прокручивало страницу вниз.
- 0.22
  - Удален `// @noframes` и включен `all_frames: true`, чтобы позволить UTags работать внутри iframe, улучшая совместимость с расширением utags-shortcuts и пользовательскими скриптами.
  - Обновлен модуль настроек.
- 0.21
