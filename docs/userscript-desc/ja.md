...
- その他多数。新しいサイトの追加を提案するには[こちら](https://github.com/utags/utags/issues)をクリックしてください。
...
- 📺 YouTube: [デモ 1](https://www.youtube.com/watch?v=WzUzBA5V91A) [デモ 2](https://www.youtube.com/watch?v=zlNqk0nhLdI)
...
- 0.22
  ...
  - 設定モジュールを更新しました。
- 0.21
  - リモートバージョンの異常処理を最適化：確認後、初回マージ（`lastSyncTime=0`、新しいデータを優先）を実行するか、キャンセルして同期を無効化します。
  - 新しいメニューコマンド：すべてのタグを非表示/再表示、動的タイトルと多言語対応。
- 0.20
...
- 0.8.9
  - bilibili.com、greasyfork.org、youtube.com、douyin.com のスタイルとマッチングルールを更新
- 0.8.8
