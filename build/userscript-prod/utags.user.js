...
;(() => {
  ...
  function getUserProfileUrl4(href) {
    if (href.startsWith(prefix4) || href.startsWith(prefix23)) {
  ...
  function getCanonicalUrl5(url) {
    if (url.startsWith(prefix9)) {
      const href2 = url.slice(prefix9.length)
  ...
  function getUserProfileUrl10(url, exact = false) {
    if (url.startsWith(prefix10) || url.startsWith(prefix25)) {
  ...
  var prefix14 = "https://www.pixiv.net/"
    ...
    if (url.startsWith(prefix14)) {
      ...
      if (exact) {
        if (/^users\/\d+([?#].*)?$/.test(href2)) {
          return prefix14 + href2.replace(/^(users\/\d+).*/, "$1")
        }
  ...
  function getUserProfileUrl14(url, exact = false) {
    if (url.startsWith(prefix15)) {
      ...
      if (exact) {
        if (/^u\/[\w.-]+([?#].*)?$/.test(href2)) {
          return prefix15 + href2.replace(/^(u\/[\w.-]+).*/, "$1")
        }
  ...
  function getUserProfileUrl15(url) {
    if (url.startsWith(prefix16)) {
      ...
      if (/^nuke\.php\?func=ucp&uid=\d+/.test(href2)) {
        return (
          prefix16 + href2.replace(/^(nuke\.php\?func=ucp&uid=\d+).*/, "$1")
        )
      }
    }
    return void 0
  ...
  var prefix17 = "https://www.dlsite.com/"
  function getProductUrl(url) {
    if (url.startsWith(prefix17)) {
      const href2 = url.slice(prefix17.length)
      if (href2.includes("=/product_id/")) {
        return prefix17 + href2.replace(/^(.+\.html).*/, "$1")
      }
    }
    return void 0
  }
  ...
  function getUserProfileUrl16(url, exact = false) {
    if (url.startsWith(prefix18)) {
      ...
      if (exact) {
        if (/^\?\d+(#.*)?$/.test(href2)) {
          return (
            prefix18 + href2.replace(/^\?(\d+).*/, "home.php?mod=space&uid=$1")
          )
        }
  ...
  var prefix19 = "https://www.pornhub.com/"
    ...
    if (href.includes("pornhub.com")) {
      ...
      if (exact) {
        if (/^(model|users)\/[\w-]+(\?.*)?$/.test(href2)) {
          return prefix19 + href2.replace(/(^(model|users)\/[\w-]+).*/, "$1")
        }
    ...
    if (href.includes("pornhub.com")) {
      ...
      if (exact) {
        if (/^channels\/[\w-]+(\?.*)?$/.test(href2)) {
          return prefix19 + href2.replace(/(^channels\/[\w-]+).*/, "$1")
        }
  ...
  function getVideoUrl4(href) {
    if (href.includes("pornhub.com")) {
      ...
      if (/^view_video.php\?viewkey=\w+/.test(href2)) {
        return prefix19 + href2.replace(/(view_video.php\?viewkey=\w+).*/, "$1")
      }
    }
    return void 0
  }
  ...
  function getPostUrl4(url) {
    if (url.startsWith(prefix20)) {
      ...
      if (/^g\/\w+/.test(href2)) {
        return prefix20 + href2.replace(/^(g\/\w+\/\w+\/).*/, "$1")
      }
    }
    ...
    if (url.startsWith(prefix21)) {
      ...
      if (exact) {
        if (/^archive\/\d+\/(\?.*)?$/.test(href2)) {
          return prefix21 + href2.replace(/^(archive\/\d+\/).*/, "$1")
        }
  ...
  var prefix27 = "https://www.dmm.co.jp/"
  function getCanonicalUrl9(url) {
    if (url.startsWith(prefix27)) {
      const href2 = url.slice(prefix27.length)
      if (href2.includes("/=/")) {
        return prefix27 + href2.replace(/\?.*/, "")
      }
    }
    return url
  }
  ...
  function getPostUrl6(url) {
    if (url.startsWith(prefix28)) {
      ...
      if (/^\w+\/user\/\w+\/post\/\w+/.test(href2)) {
        return prefix28 + href2.replace(/^(\w+\/user\/\w+\/post\/\w+).*/, "$1")
      }
    }
    return void 0
  }
