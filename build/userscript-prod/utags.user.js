...
;(() => {
  ...
  function updateInputedTagList(ul) {
    ul.textContent = ""
      ...
      switch (event.key) {
        ...
        case "ArrowLeft": {
          ...
          if (current) {
            ...
            const parentPrevious = parentElement.previousElementSibling
            if (parentPrevious) {
              removeAllActive()
        ...
        case "ArrowRight": {
          ...
          if (current) {
            ...
            const parentNext = parentElement.nextElementSibling
            if (parentNext) {
              removeAllActive()
