...
// @name:zh-HK           🏷️ 小魚標籤 (UTags) - 為連結添加用戶標籤 - staging
// @name:zh-TW           🏷️ 小魚標籤 (UTags) - 為連結新增使用者標籤 - staging
// @name:ja              🏷️ 小魚タグ (UTags) - リンクにユーザータグを追加 - staging
// @name:ko              🏷️ UTags - 링크에 사용자 태그 추가 - staging
// @name:de              🏷️ UTags - Benutzer-Tags zu Links hinzufügen - staging
// @name:fr              🏷️ UTags - Ajouter des tags utilisateur aux liens - staging
// @name:es              🏷️ UTags - Agregar etiquetas de usuario a los enlaces - staging
// @name:it              🏷️ UTags - Aggiungi tag utente ai collegamenti - staging
// @name:pt              🏷️ UTags - Adicionar tags de usuário aos links - staging
// @name:pt-BR           🏷️ UTags - Adicionar tags de usuário aos links - staging
// @name:vi              🏷️ UTags - Thêm tag người dùng vào liên kết - staging
...
// @description:pt-BR    Melhore sua experiência de navegação adicionando tags personalizadas e notas a usuários, posts e vídeos na web. Perfeito para organizar conteúdo, identificar usuários e filtrar posts indesejados. Suporta mais de 100 sites populares, incluindo X (Twitter), Reddit, Facebook, Instagram, YouTube, TikTok, GitHub, Hacker News, Greasy Fork, pixiv, Twitch e muitos outros.
